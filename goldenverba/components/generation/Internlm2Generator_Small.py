...
class Internlm2Generator_Small(Generator):
    """
    Internlm2Generator Generator.
    """

    def __init__(self):
        super().__init__()
        self.name = "Internlm2Generator_Small"
        self.description = "Generator using Sensetime's Internlm2Generator_Small model"
        self.requires_library = ["huggingface_hub", "transformers"]
        self.requires_env = ["HF_TOKEN", "INTERNLM2-CHAT-1_8B-HF"]
        self.streamable = True
        self.model = None
        self.tokenizer = None
        self.device = None
        self.context_window = 190000
        if os.environ.get("INTERNLM2-CHAT-1_8B-HF", "").lower() == "true":
            try:
                import torch
                ...
                self.model = AutoModelForCausalLM.from_pretrained(
                    "internlm2-1_8b",trust_remote_code=True,
                ...
                msg.info("Loading Intern_Small Model")
    ...
    async def generate_stream(
        ...
        try:
            ...
            if self.tokenizer is None or self.model is None:
                raise Exception("Tokenizer or model has not been initialized.")
            ...
            input = self.tokenizer(
                ...
                padding=True,
                truncation=True,
                max_length=100000,  # Specify a max_length value
            )
