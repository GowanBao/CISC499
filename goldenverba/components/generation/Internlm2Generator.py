...
class Internlm2Generator(Generator):
    """
    ...
    def __init__(self):
        super().__init__()
        self.name = "Internlm2Generator"
        self.description = "Generator using Sensetime's Internlm2-7B-4bit-HF model"
        self.requires_library = ["huggingface_hub", "transformers"]
        self.requires_env = ["HF_TOKEN", "INTERNLM2-CHAT-7B-4BIT-HF"]
        self.streamable = True
        self.model = None
        self.tokenizer = None
        self.device = None
        self.context_window = 190000
        if os.environ.get("INTERNLM2-CHAT-7B-4BIT-HF", "").lower() == "true":
            try:
                import torch
                ...
                self.model = AutoModelForCausalLM.from_pretrained(
                    ...
                    device_map=self.device, load_in_4bit=True,
                )
